...
from EGAMI.EGAMI_services_config import EGDropbearConfig, EGPcscdConfig
...
def EgamiSeparatorEntryComponent(sep, width=800):
    ...
    return [
     sep,
     MultiContentEntryPixmapAlphaBlend(pos=(10, 24), size=(width, 2), png=png)]
...
class EgamiMainPanel(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['SetupActions', 'WizardActions', 'MenuActions', 'MoviePlayerActions'], {'ok': self.keyOk,
           'back': self.keyRed,
           'cancel': self.keyRed,
           'left': self.goLeft,
           'right': self.goRight,
                                                                                                                                                                ...
                                                                                                                                                                if selected == _('Show Uptime'):
                                                                                                                                                                    ...
                                                                                                                                                                    if selected == _('Show Network Connections'):
                                                                                                                                                                        ...
                                                                                                                                                                        if selected == _('Show Routing Table'):
                                                                                                                                                                            ...
                                                                                                                                                                            if selected == _('Show System Memory Info'):
                                                                                                                                                                                ...
                                                                                                                                                                                if selected == _('Show Network Details'):
                                                                                                                                                                                    ...
                                                                                                                                                                                    if selected == _('Show HDD Temperature'):
                                                                                                                                                                                        ...
                                                                                                                                                                                        if selected == _('Show Stream Info'):
                                                                                                                                                                                            self.session.open(EGStreamInfo)
                                                                                                                                                                                        else:
                                                                                                                                                                                            if selected == _('EGAMI Personal Backup'):
                                                                                                                                                                                                ...
                                                                                                                                                                                                if selected == _('EGAMI Full Backup'):
                                                                                                                                                                                                    if self.checkMountedDevices():
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    if selected == _('Swap File Setup'):
                                                                                                                                                                                                        ...
                                                                                                                                                                                                        if selected == _('Download EGAMI Addons'):
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            if selected == _('Download Plugins'):
                                                                                                                                                                                                                self.session.open(PluginDownloadBrowser, 0)
                                                                                                                                                                                                            else:
                                                                                                                                                                                                                if selected == _('User Server Addons'):
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    if selected == _('Install Tar.gz and IPK Addons'):
                                                                                                                                                                                                                        self.session.open(EG_Manual_installation)
                                                                                                                                                                                                                    else:
                                                                                                                                                                                                                        if selected == _('Remove Plugins'):
                                                                                                                                                                                                                            self.session.open(PluginDownloadBrowser, 1)
                                                                                                                                                                                                                        else:
                                                                                                                                                                                                                            if selected == _('Remove EGAMI addons'):
    ...
    def GenerateServicesMenu(self):
        ...
        self.list.append(EgamiMenuEntryComponent('Pcscd', _('Setup Pcscd'), _('Setup Pcscd'), 'services/pcscd'))
        self['list'].l.setList(self.list)
...
class EGKernelInfo(Screen):
    ...
    def __init__(self, session):
        ...
        self['menu'] = MenuList(self.list)
        self.onLayoutFinish.append(self.fillList)
        self['actions'] = ActionMap(['EGActions'], {'exit': self.Exit
           }, -1)
...
# okay decompiling EGAMI_main.pyo
