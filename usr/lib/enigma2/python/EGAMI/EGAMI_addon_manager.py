...
class EG_InternetAddons(Screen):
    ...
    def __init__(self, session, parent, childNode, url):
        ...
        self['actions'] = ActionMap(['ColorActions', 'OkCancelActions',
         'MovieSelectionActions'], {'ok': self.nacisniecieOK,'red': self.nacisniecieOK,
...
class EGAddonRemove(Screen):
    ...
    def __init__(self, session):
        ...
        self['actions'] = ActionMap(['ColorActions', 'WizardActions',
         'DirectionActions'], {'ok': self.askRemoveIPK,'red': self.askRemoveIPK,
           'back': self.closeAndReload
           }, -1)
        self.populateSL()
...
class EG_Manual_installation(Screen):
    ...
    def __init__(self, session, args=None):
        ...
        self['actions'] = ActionMap(['ColorActions', 'WizardActions',
         'DirectionActions'], {'ok': self.start,'red': self.start,
           'back': self.closeAndReload
           }, -1)
        ...
        try:
            if self['listaaddonow'].canDescent():
                ...
                if self.installItem.endswith('.ipk'):
                    ...
                    if self.installItem.endswith('tar.gz'):
                        ...
                        if self.installItem.endswith('tar.bz2'):
...
def EgamiAddonSeparatorEntryComponent(sep, width=500):
    ...
    return [
     sep,
     MultiContentEntryPixmapAlphaTest(pos=(10, 24), size=(width, 2), png=png)]
