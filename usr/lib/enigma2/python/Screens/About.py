...
from boxbranding import getBoxType, getMachineBuild, getMachineBrand, getMachineName, getImageVersion, getImageBuild, getDriverDate, getOEVersion
...
def getAboutText():
    ...
    if getMachineBuild() in ('vusolo4k', 'vuultimo4k', 'vuzero4k'):
        ...
        if getMachineBuild() in ('formuler1tc', 'formuler1', 'triplex', 'tiviaraplus'):
            ...
            if getMachineBuild() in ('u5', 'u5pvr'):
                ...
                if getMachineBuild() in ('vuuno4kse', 'vuuno4k', 'dm900', 'dm920',
                                         'gb7252', 'dags7252', 'xc7439', '8100s'):
                    cpuMHz = '   (1,7 GHz)'
                else:
                    if getMachineBuild() in ('sf5008', 'et13000', 'et1x000', 'hd52',
    ...
    if path.exists('/boot/STARTUP'):
        ...
        if path.exists('/boot/cmdline.txt'):
    ...
    if getMachineBuild() not in ('vuzero4k', 'sf5008', 'et13000', 'et1x000', 'hd51',
                                 'hd52', 'vusolo4k', 'vuuno4k', 'vuuno4kse', 'vuultimo4k',
                                 'sf4008', 'dm820', 'dm7080', 'dm900', 'dm920', 'gb7252',
                                 'dags7252', 'vs1500', 'h7', 'xc7439', '8100s', 'u5',
                                 'u5pvr'):
